...
public class PrimitiveTypes extends TypesInit
{
	...
	static
	{
		...
		STRING.addConstructor(FunctionParameters.create(STRING, BOOL), new Constructor(args -> newValue(STRING, String.valueOf(args[0].getBoolean()))));
